...
// Nota: no limitamos aquí por plan. El límite real de unidades lo controla /api/tenant/rooms
// y el plan/billing. En Propiedades solo se deben mostrar los slots existentes sin romper tenants legacy.
