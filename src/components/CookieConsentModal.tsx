...
export default function CookieConsentModal() {
  ...
  useEffect(() => {
    ...
    const handler = (event: Event) => {
      const custom = event as CustomEvent<{ view?: 'manage' }>;
      if (custom.detail?.view === 'manage') {
        ...
        <div className="space-y-4">
          ...
          {!showAdvanced && (
            <button
              ...
              className="text-sm font-medium text-blue-600 underline underline-offset-4 transition hover:text-blue-700"
            >
